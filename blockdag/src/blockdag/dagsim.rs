...
use crate::blockdag::Block;
use crate::blockdag::{sizeof_pastset, sorted_keys_by_height};

pub fn dag_add_block(
    name: &str,
    references: &Vec<&str>,
    dag: &mut HashMap<String, Arc<RwLock<Block>>>,
) {
    //create this block
        ...
        match value {
            ...
            Some(block) => {
                ...
                // add previous blocks to this block
                {
                    ...
                    this_block_w
                        .prev
                        .insert(reference_block.name.clone(), Arc::clone(block));
                ...
                reference_block
                    .next
                    .insert(String::from(name.clone()), Arc::clone(&this_block));
            }
        }
    }
